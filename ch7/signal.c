 ...
 *                 
 *        Version:  1.0.0(2023年04月03日)
 *         Author:  MoWeida <2594041017@qq.com>
 *      ChangeLog:  1, Release initial version on "2023年04月03日 23时00分23秒"
 *                 
 ********************************************************************************/
...
int main(int argc, char **argv)
{
	...
	else if(pid == 0)
	{
		...
		printf("Child process start receive signal from parent and exit now.\n");
		return 0;
	}
