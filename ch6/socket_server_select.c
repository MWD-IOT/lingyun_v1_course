 ...
 *      ChangeLog:  1, Release initial version on "2023年04月01日 11时54分35秒"
 *                 
 ********************************************************************************/
...
int main(int argc, char **argv)
{
	...
	printf("Server [%s] start to listen on prot [%d]...\n", argv[0], serv_port);
...
static inline void print_usage(char *progname)
{
	...
	printf("%s is a socket server progname, which used to verify client and echo back dtring from it.\n", progname);
